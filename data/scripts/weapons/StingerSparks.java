...
/**
 * An on-hit particle effect that kind of badly simulates sparks or
 * bullets ricocheting off armour.
 * @author Eliza Weisman
 */
public class StingerSparks implements OnHitEffectPlugin {

    // likelihood of creating sparks (0 - 1)
    private static final float SPARK_CHANCE = 0.25f;
    // color of spawned particles
    private static final Color PARTICLE_COLOR = new Color(255,175,100,255);
    ...
    private static final float VEL_MIN = 0.07f;
    // constant that effects the upper end of the particle velocity
    private static final float VEL_MAX = 0.175f;
